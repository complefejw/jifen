...
namespace 消防积分获取
{
	...
	public class SqliteHelper
	{
		...
		public SQLiteConnection GetSQLiteConnection()
		{
			...
			var con = new SQLiteConnection("Data Source="+"./InfoServiceDbB.db");
			return con;
		}
		...
		public void PrepareCommand(SQLiteCommand cmd, SQLiteConnection conn, string cmdText, Dictionary<String, String> data)
		{
